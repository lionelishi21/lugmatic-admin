                    ...
                    <div className="space-y-6">
                      <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
                        <div className="space-y-3">
                          <h3 className="text-2xl font-bold text-zinc-900 dark:text-white tracking-tight leading-tight">{track.title}</h3>
                          <div className="flex items-center gap-3">
                            <div className="relative">
                              ...
                              />
                              <div className="absolute -bottom-1 -right-1 w-2.5 h-2.5 bg-black rounded-full border border-black/10 dark:border-white/10 flex items-center justify-center">
                                <CheckCircle2 size={8} className="text-emerald-500" />
                              </div>
                            </div>
                            <span className="text-sm font-semibold text-zinc-600 dark:text-zinc-400 group-hover:text-zinc-900 dark:text-white transition-colors">{track.artist.name}</span>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                          <button
                            ...
                            className="flex items-center gap-2 px-6 py-3 bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 text-zinc-900 dark:text-white text-sm font-semibold rounded-xl hover:bg-rose-500/10 hover:text-rose-500 hover:border-rose-500/30 transition-all"
                          >
                            <XCircle size={18} />
                            Reject
                          </button>
                      ...
                      <div className="space-y-2 bg-black/20 p-4 rounded-xl border border-black/5 dark:border-white/5">
                        <p className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Lyrics / Description</p>
                        <p className="text-sm text-zinc-700 dark:text-zinc-300 max-w-3xl leading-relaxed">{track.description}</p>
                      </div>
                    </div>

                    <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5 flex flex-wrap items-center justify-between gap-6">
                      <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-black/5 dark:bg-white/5 rounded-lg border border-black/5 dark:border-white/5">
                          <Tag size={14} className="text-zinc-600 dark:text-zinc-400" />
                          <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">{track.genre}</span>
                        </div>
