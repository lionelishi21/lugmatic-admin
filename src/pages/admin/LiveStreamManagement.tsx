  ...
  return (
    <div className="fixed inset-0 bg-black/95 backdrop-blur-3xl flex items-center justify-center z-[100]" onClick={onClose}>
      <motion.div 
        ...
        className="bg-zinc-100 dark:bg-zinc-950/40 border border-emerald-500/10 rounded-[3rem] shadow-[0_30px_100px_rgba(0,0,0,1)] max-w-6xl w-full mx-6 aspect-video relative overflow-hidden backdrop-blur-2xl" 
      ...
      >
        <div className="absolute top-0 left-0 right-0 p-10 flex items-center justify-between z-30 bg-gradient-to-b from-black/90 via-black/40 to-transparent">
          <div className="flex items-center gap-6">
            ...
            <div className="h-10 w-px bg-black/5 dark:bg-white/5 mx-2" />
            <div>
               <h2 className="text-zinc-900 dark:text-white text-2xl font-bold tracking-tighter uppercase leading-none mb-1.5">{stream.title}</h2>
          ...
          <button onClick={onClose} className="w-14 h-14 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 text-zinc-500 hover:text-zinc-900 dark:text-white hover:bg-black/5 dark:bg-white/5 transition-all shadow-inner flex items-center justify-center">
            <X size={24} />
          </button>
        </div>
        ...
        {loading ? (
          ...
          <div className="h-full w-full relative">
            ...
            <div className="absolute bottom-10 left-10 right-10 flex items-end justify-between z-30">
               <div className="flex gap-4">
                  <div className="premium-card !bg-black/60 !backdrop-blur-xl border-black/5 dark:border-white/5 p-4 flex items-center gap-4">
                     ...
                     <div>
                        ...
                        <p className="text-lg font-bold text-zinc-900 dark:text-white tabular-nums leading-none">{(stream.currentViewers || 0).toLocaleString()}</p>
                     </div>
                  </div>
                  <div className="premium-card !bg-black/60 !backdrop-blur-xl border-black/5 dark:border-white/5 p-4 flex items-center gap-4">
                     ...
                     <div>
                        ...
                        <p className="text-lg font-bold text-zinc-900 dark:text-white tabular-nums leading-none">${stream.totalGiftValue || 0}</p>
                     </div>
                  </div>
               </div>
               
               <div className="premium-card !bg-black/60 !backdrop-blur-xl border-black/5 dark:border-white/5 p-4 flex items-center gap-6">
                  <div className="flex items-center gap-4 border-r border-black/5 dark:border-white/5 pr-6">
                  ...
                  <div className="flex items-center gap-4">
                     <button className="w-10 h-10 bg-zinc-50 dark:bg-zinc-950 rounded-xl flex items-center justify-center border border-black/5 dark:border-white/5 text-zinc-500 hover:text-zinc-900 dark:text-white transition-all"><Camera size={18} /></button>
                     <button className="w-10 h-10 bg-zinc-50 dark:bg-zinc-950 rounded-xl flex items-center justify-center border border-black/5 dark:border-white/5 text-zinc-500 hover:text-zinc-900 dark:text-white transition-all"><Mic size={18} /></button>
                     <button className="px-6 h-10 bg-rose-600 text-zinc-900 dark:text-white rounded-xl text-[9px] font-bold uppercase tracking-widest">Disconnect</button>
                  </div>
               </div>
            </div>
          </div>
          ...
          <div className="h-full flex flex-col items-center justify-center text-center p-24">
            <div className="w-24 h-24 bg-zinc-50 dark:bg-zinc-950 rounded-[2.5rem] flex items-center justify-center mx-auto mb-10 border border-black/5 dark:border-white/5 shadow-2xl relative overflow-hidden group">
               <div className="absolute inset-0 bg-rose-500/5 animate-pulse" />
               <AlertCircle size={40} className="text-rose-500 relative z-10" />
            </div>
            <h3 className="text-[10px] font-bold text-zinc-900 dark:text-white uppercase tracking-widest mb-4">Connection Failed</h3>
...
function StreamVideoRenderer() {
  ...
  return (
    <div className="h-full w-full bg-black relative">
      ...
      {audioTracks.map((t, i) => <AudioTrack key={i} trackRef={t} />)}
      <div className="absolute inset-0 pointer-events-none border-t border-black/5 dark:border-white/5" />
    </div>
  );
}
  ...
  return (
    <div className="space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-white leading-none">Live Stream Management</h1>
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="h-16 px-8 bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 text-zinc-500 hover:text-zinc-900 dark:text-white hover:bg-black/5 dark:bg-white/5 rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all shadow-inner flex items-center justify-center gap-3"
          >
            <RefreshCw size={18} className="group-hover:rotate-180 transition-transform duration-700" />
            Refresh
          </button>
          <button className="h-16 px-10 bg-white text-black rounded-2xl text-[10px] font-bold uppercase tracking-widest hover:scale-105 transition-all shadow-2xl flex items-center justify-center gap-4 group border border-black/10 dark:border-white/10">
            <Plus size={18} />
            Create Stream
          </button>
        </div>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {streams.length === 0 ? (
            <div className="col-span-full py-40 text-center premium-card border-black/5 dark:border-white/5 shadow-2xl group">
              <div className="w-24 h-24 bg-zinc-50 dark:bg-zinc-950 rounded-[2.5rem] flex items-center justify-center mx-auto mb-10 border border-black/5 dark:border-white/5 shadow-2xl group-hover:border-rose-500/20 transition-all">
                <Video size={36} className="text-zinc-800 group-hover:text-rose-500 transition-colors" />
              </div>
              <h3 className="text-[10px] font-bold text-zinc-900 dark:text-white uppercase tracking-widest mb-3">No Streams Found</h3>
            ...
            streams.map((stream, i) => (
              ...
              >
                {/* Cover Image */}
                <div className="relative aspect-video bg-zinc-50 dark:bg-zinc-950 overflow-hidden">
                  {stream.coverImage ? (
                    <img 
                    ...
                    <div className="w-full h-full flex items-center justify-center text-zinc-900 bg-white/40 dark:bg-black/40"><Radio size={48} /></div>
                  )}
                  ...
                  <div className="absolute top-6 left-6 z-20">
                    {stream.status === 'live' ? (
                      <div className="flex items-center gap-3 px-4 py-2 rounded-2xl bg-rose-500 text-zinc-900 dark:text-white text-[9px] font-black tracking-widest shadow-[0_0_20px_rgba(244,63,94,0.4)] border border-black/10 dark:border-white/10">
                        <span className="w-1.5 h-1.5 rounded-full bg-white animate-pulse" />
                        LIVE
                      </div>
                    ) : (
                      <div className="px-4 py-2 rounded-2xl bg-black/80 backdrop-blur-xl text-zinc-500 text-[9px] font-black uppercase tracking-widest border border-black/5 dark:border-white/5">
                  ...
                  <div className="absolute inset-0 bg-white/60 dark:bg-black/60 opacity-0 group-hover:opacity-100 transition-all z-20 flex flex-col items-center justify-center gap-6 backdrop-blur-sm">
                    <div className="flex gap-4">
                       {stream.status === 'live' && (
                       ...
                       {stream.status === 'live' && (
                          <button onClick={() => setEndingStream(stream)} className="h-14 px-8 bg-rose-600 text-zinc-900 dark:text-white rounded-2xl text-[9px] font-bold uppercase tracking-widest flex items-center gap-3 shadow-2xl hover:bg-rose-500 transition-all">
                            <Square size={18} /> End Stream
                          </button>
                       )}
                       {stream.isRecorded && stream.recordingUrl && (
                          <button onClick={() => setViewingRecording(stream)} className="h-14 px-8 bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-white rounded-2xl text-[9px] font-bold uppercase tracking-widest flex items-center gap-3 shadow-2xl border border-black/10 dark:border-white/10 hover:bg-black/5 dark:bg-white/5 transition-all">
                ...
                <div className="p-8 relative">
                  <div className="flex items-start justify-between gap-6 mb-10">
                    <div className="flex items-center gap-5 min-w-0">
                      <div className="w-14 h-14 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 overflow-hidden flex-shrink-0 shadow-inner group-hover:scale-110 transition-transform duration-500 relative">
                        <img 
                      ...
                      <div className="min-w-0">
                        <h3 className="text-xl font-bold text-zinc-900 dark:text-white truncate tracking-tight group-hover:text-emerald-400 transition-colors uppercase leading-none mb-2">{stream.title}</h3>
                        <p className="text-[10px] text-zinc-600 font-bold uppercase tracking-widest leading-none">{stream.host.name}</p>
                      </div>
                    </div>
                    <div className="relative">
                      <button onClick={() => setOpenMenuId(openMenuId === stream._id ? null : stream._id)} className="w-12 h-12 rounded-2xl bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 text-zinc-600 hover:text-zinc-900 dark:text-white hover:bg-black/5 dark:bg-white/5 transition-all shadow-inner flex items-center justify-center">
                      ...
                      <AnimatePresence>
                        {openMenuId === stream._id && (
                          <motion.div 
                            ...
                            className="absolute bottom-full right-0 mb-4 w-64 bg-zinc-900 border border-black/10 dark:border-white/10 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.8)] z-30 p-3 overflow-hidden backdrop-blur-2xl"
                          >
                            ...
                            <button onClick={() => { setSelectedStream(stream); setOpenMenuId(null); }} className="w-full flex items-center gap-4 px-5 py-4 rounded-2xl text-[10px] font-bold uppercase tracking-widest text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:text-white hover:bg-black/5 dark:bg-white/5 transition-all group/opt">
                            ...
                            {stream.isRecorded && (
                              <button onClick={() => handleStreamAction(stream._id, 'delete-recording')} className="w-full flex items-center gap-4 px-5 py-4 rounded-2xl text-[10px] font-bold uppercase tracking-widest text-zinc-500 hover:bg-black/5 dark:bg-white/5 hover:text-zinc-900 dark:text-white transition-all group/opt">
                    ...
                    <div className="flex items-center gap-10">
                      <div className="flex items-center gap-3">
                         ...
                         <div className="flex flex-col">
                            <span className="text-[10px] font-bold text-zinc-900 dark:text-white tabular-nums leading-none">{(stream.currentViewers || 0).toLocaleString()}</span>
                      ...
                      <div className="flex items-center gap-3">
                         ...
                         <div className="flex flex-col">
                            <span className="text-[10px] font-bold text-zinc-900 dark:text-white tabular-nums leading-none">${stream.totalGiftValue || 0}</span>
                            <span className="text-[8px] font-black text-zinc-700 uppercase tracking-widest mt-1">Gifts</span>
                         </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-2.5 px-3 py-1.5 bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 rounded-xl shadow-inner">
            ...
            >
              <div className="flex justify-between items-center mb-10 border-b border-black/5 dark:border-white/5 pb-10">
                <div className="flex items-center gap-5">
                   ...
                   <div>
                      <h3 className="text-2xl font-bold text-zinc-900 dark:text-white uppercase tracking-tighter leading-none mb-1.5">Stream Statistics</h3>
                ...
                <button onClick={() => setSelectedStream(null)} className="w-12 h-12 rounded-2xl flex items-center justify-center hover:bg-black/5 dark:bg-white/5 text-zinc-500 transition-all border border-black/5 dark:border-white/5 shadow-inner"><X size={24} /></button>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 mb-12">
                {[
                  ...
                  <div key={metric.label} className="bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 p-8 rounded-[2rem] text-center shadow-inner hover:border-emerald-500/20 transition-all group/met">
                    <div className={`w-12 h-12 ${metric.bg} rounded-2xl flex items-center justify-center mx-auto mb-6 border border-black/5 dark:border-white/5 group-hover/met:scale-110 transition-transform duration-500`}>
                       <metric.icon size={20} className={metric.color} />
                    </div>
                    <p className="text-3xl font-bold text-zinc-900 dark:text-white tracking-tighter italic tabular-nums leading-none mb-2">{metric.value || 0}</p>
              ...
              <div className="space-y-6 pt-10 border-t border-black/5 dark:border-white/5">
                {[
                  ...
                  <div key={item.label} className="flex justify-between items-center px-4 py-3 bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 rounded-2xl shadow-inner">
                    <span className="text-[9px] text-zinc-600 font-bold uppercase tracking-widest">{item.label}</span>
                    <span className="text-[11px] text-zinc-900 dark:text-white font-bold tracking-widest">{item.value}</span>
                  </div>
                ))}
              </div>
            </motion.div>
        ...
        {viewingRecording && (
          <div className="fixed inset-0 bg-black/98 backdrop-blur-3xl flex items-center justify-center z-[130]" onClick={() => setViewingRecording(null)}>
            <motion.div 
              ...
              className="max-w-7xl w-full mx-6 aspect-video relative rounded-[4rem] overflow-hidden border border-black/10 dark:border-white/10 shadow-[0_50px_150px_rgba(0,0,0,1)]" onClick={e => e.stopPropagation()}
            >
              ...
              <div className="absolute top-8 left-8 right-8 flex items-center justify-between pointer-events-none z-30">
                 <div className="px-6 py-3 bg-black/80 backdrop-blur-xl rounded-2xl border border-black/10 dark:border-white/10">
                    <p className="text-[10px] font-black text-zinc-900 dark:text-white uppercase tracking-widest">Playback: {viewingRecording.title.toUpperCase()}</p>
                 </div>
                 <button onClick={() => setViewingRecording(null)} className="w-16 h-16 rounded-[2rem] bg-black/80 backdrop-blur-xl text-zinc-900 dark:text-white pointer-events-auto border border-black/10 dark:border-white/10 flex items-center justify-center hover:bg-black/5 dark:bg-white/5 transition-all">
                    <X size={28} />
                  </button>
              </div>
            </motion.div>
        ...
        {endingStream && (
          <div className="fixed inset-0 z-[140] flex items-center justify-center p-6 bg-black/80 backdrop-blur-xl" onClick={() => !confirmingEnd && setEndingStream(null)}>
            <motion.div
              ...
              className="w-full max-w-sm bg-zinc-900 border border-black/10 dark:border-white/10 rounded-[2rem] p-8 shadow-2xl text-center"
              onClick={e => e.stopPropagation()}
            >
              ...
              <h2 className="text-xl font-bold text-zinc-900 dark:text-white mb-2 uppercase tracking-tight">End This Stream?</h2>
              <p className="text-sm text-zinc-500 mb-2 leading-relaxed">
                You are about to force-end
              </p>
              <p className="text-sm font-bold text-zinc-900 dark:text-white mb-6 truncate px-4">"{endingStream.title}"</p>
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  className="w-full h-14 bg-rose-500 hover:bg-rose-400 text-zinc-900 dark:text-white rounded-2xl text-sm font-bold uppercase tracking-widest transition-all disabled:opacity-60 flex items-center justify-center gap-3"
                >
                  {confirmingEnd
                ...
                <button
                  ...
                  disabled={confirmingEnd}
                  className="w-full h-14 bg-zinc-50 dark:bg-zinc-950 hover:bg-zinc-800 text-zinc-900 dark:text-white border border-black/10 dark:border-white/10 rounded-2xl text-sm font-bold uppercase tracking-widest transition-all disabled:opacity-60"
                >
                  Cancel
                </button>
              </div>
