      ...
      >
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <motion.button
            ...
            className="w-full bg-gradient-to-r from-green-500 via-lime-500 to-emerald-500 text-zinc-900 dark:text-white py-3 px-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed mt-2"
