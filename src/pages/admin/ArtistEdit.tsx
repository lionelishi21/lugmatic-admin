      ...
      >
        <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6">
                ...
                <div className="flex items-start space-x-6">
                  <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-gray-200 bg-gray-50 flex shrink-0 items-center justify-center relative group">
                    ...
                    {/* Overlay for hover */}
                    <label htmlFor="image-upload" className="absolute inset-0 bg-white/40 dark:bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 cursor-pointer transition-opacity">
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              type="submit"
              className="px-4 py-2 bg-green-600 text-zinc-900 dark:text-white rounded-lg hover:bg-green-700 disabled:opacity-50"
              disabled={isSubmitting}
            >
