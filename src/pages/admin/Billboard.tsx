...
const Billboard: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto pb-24 space-y-10">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-white leading-none uppercase">Billboard</h1>
        ...
        <div className="flex bg-zinc-50 dark:bg-zinc-950 border border-black/5 dark:border-white/5 rounded-[2rem] p-1.5 gap-1">
          {[
      ...
      {/* Rankings List */}
      <div className="premium-card !p-0 overflow-hidden border-black/5 dark:border-white/5 shadow-2xl relative min-h-[600px] rounded-[3rem]">
        <div className="px-10 py-6 border-b border-black/5 dark:border-white/5 flex items-center justify-between bg-zinc-950/20">
          <div className="flex items-center gap-4 text-xs font-bold text-zinc-900 dark:text-white uppercase tracking-widest">
        ...
        <AnimatePresence mode="wait">
          {loading ? (
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="py-40 text-center px-10">
              ...
              <h3 className="text-zinc-900 dark:text-white font-bold text-xl uppercase mb-3">Connection Error</h3>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-8">
                      ...
                      <div className="relative w-16 h-16 rounded-2xl bg-zinc-50 dark:bg-zinc-950 overflow-hidden border border-black/5 dark:border-white/5 group-hover:border-emerald-500/30 transition-all shrink-0">
                        <img
                        ...
                        />
                        <div className="absolute inset-0 bg-white/40 dark:bg-black/40 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-all">
                          <Play size={24} className="text-zinc-900 dark:text-white fill-current" />
                        </div>
                      </div>

                      <div className="min-w-0">
                        <h3 className="text-lg font-bold text-zinc-900 dark:text-white group-hover:text-emerald-400 transition-colors truncate max-w-[200px]">
                          {song.name}
                        </h3>
                    ...
                    <div className="flex items-center gap-12">
                      <div className="text-right hidden md:block">
                        <div className="flex items-center justify-end gap-2 text-zinc-900 dark:text-white font-bold text-xl tabular-nums tracking-tighter">
                      ...
                      <button className="w-12 h-12 flex items-center justify-center rounded-2xl bg-zinc-900 text-zinc-600 hover:text-zinc-900 dark:text-white hover:bg-zinc-800 transition-all border border-black/5 dark:border-white/5">
      ...
      <div className="premium-card relative overflow-hidden group border-black/5 dark:border-white/5 shadow-2xl p-10 rounded-[3rem] bg-zinc-100 dark:bg-zinc-950/40">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            <h4 className="text-xl font-bold text-zinc-900 dark:text-white mb-2 uppercase tracking-tight">Reach the Top</h4>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto shrink-0">
            <button className="h-14 px-8 bg-zinc-900 text-zinc-600 dark:text-zinc-400 border border-black/5 dark:border-white/5 rounded-2xl text-xs font-bold uppercase tracking-widest hover:text-zinc-900 dark:text-white transition-all flex items-center justify-center gap-3">
