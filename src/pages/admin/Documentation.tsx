  ...
  const tabs: TabItem[] = [
    {
      ...
      content: (
        <div className="space-y-8">
          <div className="p-8 bg-zinc-950 border border-white/5 rounded-3xl shadow-inner relative overflow-hidden">
            <div className="absolute top-0 right-0 w-48 h-48 bg-emerald-500/[0.02] rounded-bl-full pointer-events-none" />
            <h3 className="text-lg font-bold text-white uppercase tracking-tight mb-4">Welcome to Lugmatic Admin</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="premium-card border-white/5 space-y-4">
              <div className="w-10 h-10 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center">
                <Laptop className="text-emerald-500" size={20} />
              </div>
              <h4 className="text-sm font-bold text-white uppercase tracking-wider">Workspace List</h4>
              <ul className="space-y-2.5 text-zinc-500 text-xs font-semibold">
                <li><span className="text-zinc-300">lugmatic-music-webapp</span>: Fan streaming & Mixer website.</li>
                <li><span className="text-zinc-300">lugmatic-artist</span>: This react dashboard.</li>
                <li><span className="text-zinc-300">lugmatic-api</span>: Express & MongoDB REST backend.</li>
                <li><span className="text-zinc-300">lugmatic_flutter</span>: Fan Android & iOS mobile app.</li>
                <li><span className="text-zinc-300">lugmatic_artist_studio</span>: Artist broadcast & upload studio.</li>
              </ul>
            </div>
            ...
            <div className="premium-card border-white/5 space-y-4">
              ...
              <h4 className="text-sm font-bold text-white uppercase tracking-wider">Tech Stack Overview</h4>
              <ul className="space-y-2.5 text-zinc-500 text-xs font-semibold">
                <li><span className="text-zinc-300">Database</span>: MongoDB with Mongoose object modeling.</li>
                <li><span className="text-zinc-300">Streaming API</span>: LiveKit WebRTC for low latency audio broadcast.</li>
                <li><span className="text-zinc-300">Payment Processing</span>: Stripe Payment Intents & Webhooks.</li>
                <li><span className="text-zinc-300">Cloud Storage</span>: Amazon S3 for music files and images.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <div className="premium-card border-white/5">
            ...
            <div className="space-y-4 text-xs text-zinc-400 leading-relaxed">
              <p>
                When artists upload new tracks via their <span className="text-zinc-200">Artist Studio App</span>, the files are uploaded to S3 and stored in MongoDB with <code className="px-2 py-0.5 bg-zinc-900 border border-white/5 text-emerald-400 rounded">isApproved: false</code>.
              </p>
              <div className="p-4 bg-zinc-950 border border-white/5 rounded-2xl flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white uppercase tracking-wide mb-1">Upload & Queue</h4>
              ...
              <div className="p-4 bg-zinc-950 border border-white/5 rounded-2xl flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white uppercase tracking-wide mb-1">Metadata Review</h4>
              ...
              <div className="p-4 bg-zinc-950 border border-white/5 rounded-2xl flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-white uppercase tracking-wide mb-1">Approve or Flag</h4>
          ...
          <div className="premium-card border-white/5">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                ...
                <tbody className="divide-y divide-white/5 font-semibold text-zinc-400">
                  <tr>
                  ...
                  <tr>
                    <td className="py-4 font-bold text-zinc-300 uppercase tracking-wide">User (Fan)</td>
        ...
        <div className="space-y-8">
          <div className="premium-card border-white/5 space-y-4">
            ...
            <p className="text-zinc-400 text-xs leading-relaxed">
              ...
              Fans connecting via the mobile/web applications join as sub-receivers. The backend registers the active stream details and updates the status to <code className="px-2 py-0.5 bg-zinc-900 border border-white/5 text-emerald-400 rounded">live</code>.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="premium-card border-white/5 space-y-3">
              <h4 className="text-sm font-bold text-white uppercase tracking-wider">Live Battle (Clashes)</h4>
              <p className="text-zinc-400 text-xs leading-relaxed">
            ...
            <div className="premium-card border-white/5 space-y-3">
              <h4 className="text-sm font-bold text-white uppercase tracking-wider">Stream Recording (Egress)</h4>
              <p className="text-zinc-400 text-xs leading-relaxed">
        ...
        <div className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="premium-card border-white/5 space-y-3">
              ...
              <h4 className="text-xs font-bold text-white uppercase tracking-wider">Coin Purchases</h4>
            ...
            <div className="premium-card border-white/5 space-y-3">
              ...
              <h4 className="text-xs font-bold text-white uppercase tracking-wider">Digital Gifting</h4>
              <p className="text-zinc-500 text-xs font-semibold leading-relaxed">
            ...
            <div className="premium-card border-white/5 space-y-3">
              ...
              <h4 className="text-xs font-bold text-white uppercase tracking-wider">Artist Payouts</h4>
              <p className="text-zinc-500 text-xs font-semibold leading-relaxed">
          ...
          <div className="premium-card border-white/5 space-y-4">
            <h4 className="text-sm font-bold text-white uppercase tracking-wider">Gifts Customization</h4>
            <p className="text-zinc-400 text-xs leading-relaxed">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-8">
          ...
          <div className="premium-card border-white/5 space-y-4">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
              <Settings className="text-zinc-400" size={18} /> Global Settings variables
            </h3>
            <p className="text-zinc-400 text-xs leading-relaxed">
              Use "System Settings" to configure:
            </p>
            <ul className="list-disc list-inside space-y-2 text-zinc-500 text-xs font-semibold pl-2">
              <li><span className="text-zinc-300">Revenue Split Percentage</span>: Admin commission share on coin sales.</li>
              <li><span className="text-zinc-300">Minimum Payout Limit</span>: The threshold in USD/Coins for requesting payouts.</li>
              <li><span className="text-zinc-300">LiveKit Server URL & Api Keys</span>: Active endpoints for audio streaming rooms.</li>
              <li><span className="text-zinc-300">Maintenance Mode</span>: Toggling maintenance status to block user transactions during schema updates.</li>
            </ul>
          </div>
        </div>
      )
    ...
    <div className="space-y-12 pb-24">
      ...
      <div>
        <div className="flex items-center gap-3 mb-2">
          <h1 className="text-4xl font-bold tracking-tight text-white leading-none">System Documentation</h1>
      ...
      <div className="flex flex-col xl:flex-row gap-10">
        ...
        <div className="w-full xl:w-80 shrink-0">
          <div className="premium-card border-white/5 !p-3 flex flex-col gap-2 bg-[#0a0a0a]">
        ...
        <div className="flex-1 min-w-0">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Content Header Card */}
              <div className="premium-card border-white/5 bg-[#0a0a0a] relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-white/[0.01] rounded-bl-full pointer-events-none" />
                <h2 className="text-2xl font-bold text-white uppercase tracking-tight mb-2 leading-none">{currentTab.title}</h2>
